...
def download_xmls():
	...
	for folder in files.keys():
		for file in files[folder]:
			...
			r = requests.get('http://sanat.csc.fi/smsxml/xml_out/', params=payload)
...
download_xmls()
pretty_xmls()
print "\n\nAll done!\n\nMerge wiki_branch to master. Push and go to http://sanat.csc.fi/smsxml/git_postmerge/?language=" + language
